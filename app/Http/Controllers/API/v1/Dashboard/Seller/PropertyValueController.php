...
class PropertyValueController extends SellerBaseController
{

    public function __construct(private PropertyValueService $service, private PropertyValueRepository $repository)
    {
        parent::__construct();
    }
    ...
    {
        $values = $this->repository->index($request->all());

        return PropertyValueResource::collection($values);
    }
