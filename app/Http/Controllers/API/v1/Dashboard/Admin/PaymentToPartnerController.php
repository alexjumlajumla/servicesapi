...
use App\Http\Requests\PaymentToPartner\BookingStoreRequest;
...
class PaymentToPartnerController extends AdminBaseController
{
    ...
    public function bookingStoreMany(BookingStoreRequest $request): JsonResponse
    {
        $result = $this->service->bookingStoreMany($request->all());
