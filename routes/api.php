...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'selcom'], function () {
        Route::post('process', [\App\Http\Controllers\API\v1\Payment\SelcomController::class, 'processTransaction']);
        Route::get('result', [\App\Http\Controllers\API\v1\Payment\SelcomController::class, 'resultTransaction']);
    });

    Route::group(['prefix' => 'webhook'], function () {
        // Selcom Webhook
        Route::post('selcom/payment', [\App\Http\Controllers\API\v1\Payment\SelcomController::class, 'webhook']);
        
        // Other payment webhooks
